  ...
  <div class="float-right">
    ...
    <div class="input-group input-group-sm">
        ...
        <span class="input-group-append">
          ...
          <a href="/admin/kelas" class="btn btn-info btn-flat tombol-hapus"><i class="fa fa-sync-alt"></i></a>
        </span>
      </div>
      </form>
  </div>
<table id="example1" class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/admin/kelas/{{$row->id}}"><b>{{$row->name}}</a></b> </td>
      <td>
        <div class="btn-group">
            ...
            <div class="dropdown-menu" role="menu" x-placement="bottom-start">
              <a class="dropdown-item" href="/admin/kelas/{{$row->id}}/edit"><i class="fa fa-edit"></i> Edit</a>
                ...
                <form action="/admin/kelas/{{$row->id}}" method="post">
                  @method('delete')
                  @csrf
